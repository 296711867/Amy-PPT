---
name: amy-ppt-chart
description: Must be read before adding or modifying Amy-PPT slide charts. Defines product-safe Chart.js usage, canvas layout constraints, axis label rules, and retry fixes.
---
