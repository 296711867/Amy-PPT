---
name: amy-ppt-source-reading
description: Source-document reading workflow for Amy-PPT. Read before generating slides from reference documents or retrieved snippets.
---

# Amy-PPT Source Reading
