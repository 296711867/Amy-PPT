          ...
          <section className="flex min-h-[calc(100vh-220px)] items-center justify-center px-4 py-12">
            <div className="flex w-full max-w-[460px] flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold text-foreground">
                {t('htmlEditor.emptyTitle')}
              </h3>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                {t('htmlEditor.emptyHint')}
              </p>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    type="button"
                    className="mt-6 min-w-[148px]"
                    onClick={() => void handleImport()}
                    disabled={importing}
                  >
                    <FileUp className="mr-2 h-4 w-4" />
            ...
            {filteredDocuments.map((document) => {
              ...
              return (
                <div
                  ...
                  className="group overflow-hidden rounded-lg border border-border bg-card/80 shadow-[0_4px_16px_rgb(var(--ui-shadow-color)/0.08)] transition-all hover:-translate-y-0.5 hover:shadow-[0_10px_26px_rgb(var(--ui-shadow-color)/0.15)]"
                >
                  <button
                    type="button"
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="absolute bottom-3 left-3 inline-flex items-center gap-1.5 rounded-md bg-[var(--ui-surface-solid)]/92 px-2.5 py-1 text-xs font-semibold text-foreground shadow-[0_4px_12px_rgb(var(--ui-shadow-color)/0.16)] backdrop-blur-sm">
                        <Pencil className="h-3 w-3" />
                        {t('htmlEditor.edit')}
                      </span>
                    </div>
                    <div className="min-w-0 p-4">
                      <div className="line-clamp-2 min-h-10 text-base font-semibold leading-5 text-foreground">
                        {document.title || t('htmlEditor.untitled')}
                      </div>
                      <div className="mt-1.5 flex min-w-0 items-center gap-2 text-xs text-muted-foreground">
                        <span className="shrink-0 rounded border border-border bg-secondary px-1.5 py-0.5 text-[10px] font-semibold text-muted-foreground">
                          HTML
                        </span>
