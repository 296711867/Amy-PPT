      ...
      >
        <div className="space-y-2">
          ...
          {status === 'queued' || status === 'running' ? (
            ...
            <div className="flex items-center gap-2 rounded-lg border border-[#d7c59e] bg-[#fff8e8]/80 px-2.5 py-1.5 text-xs text-[#70562d] shadow-[0_6px_14px_rgba(93,107,77,0.06)]">
