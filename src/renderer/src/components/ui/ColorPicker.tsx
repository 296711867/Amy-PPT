      ...
      >
        <PopoverTrigger asChild>
          <button
            ...
            title={value}
            className="h-8 w-10 shrink-0 cursor-pointer rounded-md border border-border bg-card p-1 transition-colors hover:border-[var(--ui-border-strong)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
            <span
              ...
              style={{
                ...
                backgroundPosition:
                  allowAlpha && alpha < 1 ? '0 0, 0 3px, 3px -3px, -3px 0' : undefined
              }}
            />
          </button>
        </PopoverTrigger>
        <PopoverContent
          className="color-picker-popover w-[244px] rounded-lg border border-border bg-[var(--ui-surface-solid)] p-2 shadow-[0_14px_34px_-12px_rgb(var(--ui-shadow-color)/0.3)]"
          align="start"
          sideOffset={8}
        >
          <Chrome
          ...
          <style>{`
            .color-picker-popover .color-picker-chrome {
              ...
              overflow: hidden;
              --github-background-color: var(--ui-surface-solid);
              --github-border: 0;
              --github-box-shadow: none;
              --chrome-arrow-fill: var(--ui-text-secondary);
              --chrome-arrow-background-color: var(--ui-surface-inset);
              --editable-input-label-color: var(--ui-text-secondary);
              --editable-input-color: var(--ui-text);
              --editable-input-box-shadow: var(--ui-border) 0 0 0 1px inset;
            }
