...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        'z-50 max-w-[320px] rounded-lg border border-border bg-[var(--ui-surface-solid)] px-3 py-2 text-xs leading-5 text-foreground shadow-[0_14px_32px_rgb(var(--ui-shadow-color)/0.2)] backdrop-blur-xl',
