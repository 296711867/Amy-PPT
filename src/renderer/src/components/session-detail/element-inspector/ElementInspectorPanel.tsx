    ...
    <div className={sessionDetailRightPanelContentClass}>
      <div className="relative mx-2 mt-2 overflow-hidden rounded-[0.85rem] border border-[var(--ui-border-strong)]/58 bg-[var(--ui-surface-elevated)]/68 px-2.5 py-2 shadow-[0_2px_8px_rgba(77,61,43,0.05)]">
        ...
        <div className="relative flex items-center justify-between">
          <div>
            <div className="text-[10px] font-semibold uppercase tracking-[0.1em] text-muted-foreground/90">
          ...
          <button
            type="button"
            onClick={onClose}
            className="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-primary transition-colors hover:bg-[var(--ui-action-soft)]/70 hover:text-foreground"
      ...
      <div className="flex-1 space-y-2.5 overflow-y-auto px-2 py-2">
        {!selection || !snapshot ? (
          <div className="rounded-[0.8rem] border border-[var(--ui-danger)]/40 bg-[var(--ui-danger-soft)]/76 px-3 py-3 text-center shadow-[0_4px_10px_rgba(74,59,42,0.06)]">
            <p className="whitespace-pre-line text-[11px] leading-5 text-destructive">
