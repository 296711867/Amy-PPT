  ...
  return (
    <ToolRowShell>
      ...
      <button
        type="button"
        disabled={disabled}
        className="inline-flex h-7 shrink-0 items-center gap-1.5 rounded-full border border-[var(--ui-border-strong)]/70 bg-[var(--ui-surface-elevated)]/88 px-2.5 text-[10px] font-bold leading-none text-foreground shadow-[inset_0_1px_2px_rgba(74,59,42,0.04)] transition-colors hover:bg-[var(--ui-selected)] disabled:cursor-not-allowed disabled:opacity-50"
        onClick={() => {
