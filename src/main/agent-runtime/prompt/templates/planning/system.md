...
Each item must use exactly these fields: title, keyPoints, layoutIntent, and layoutId. Do not use alternative field names. Use null for layoutId when no universal layout fits.
Format example: [{"title":"Cover","keyPoints":["Project name and subtitle","Presenter and date","One-sentence thesis"],"layoutIntent":"cover","layoutId":null},{"title":"Three strengths","keyPoints":["Content discovery","Community trust","Purchase decisions"],"layoutIntent":"concept","layoutId":"three-cards-row"}]
