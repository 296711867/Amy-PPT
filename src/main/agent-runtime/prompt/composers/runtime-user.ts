...
export function buildPlanningUserPrompt(args: {
  ...
  return [
    ...
    sourcePlanningRules,
    "Output must be a JSON array. Each item must be exactly { title, keyPoints, layoutIntent, layoutId }; layoutId is a catalog ID or null; keyPoints must contain 1-10 strings.",
